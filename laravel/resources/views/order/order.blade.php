                                ...
                                <div class="col-md-9">
                                    <div class="list">
                                            ...
                                            @foreach($items as $item)
                                                ...
                                                @endphp
                                                <div class="row">
                                                    <div style="    padding: 20px;" class="col-md-1">{{$i.'.'}}</div>
                                                    <div class="col-md-4" style="    padding: 20px;" class="name">{{$product->name}}</div>
                                                    <div style="    padding: 20px;" class="col-md-4">${{$product->price}}x{{$item->qty}}</div>
                                                    <div  style="    padding: 20px;" class="col-md-3">Amoumt: ${{$item->total/1.21}}</div>
                                                </div>
                                                @php
